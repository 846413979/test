    ...
    private function elements(): array
    {
        $elements = [
            ...
            'CeshiTest Selection Options' => [
                ...
                ['arg' => '--test-suffix <suffixes>', 'desc' => 'Only search for test in files with specified suffix(es). Default: CeshiTest.php,.phpt'],
            ],

            'CeshiTest Execution Options' => [
